...
3. Abre **Autodesk Navisworks** y encontrarás una nueva pestaña en el Ribbon llamada **"Iron Python"** con los comandos integrados.
...
- Instalador generado automáticamente con Inno Setup.  
- Código totalmente abierto y extensible.
